    ...
    <section class="py-5 container">
        ...
        <form class="row g-3 needs-validation" method="post" enctype="multipart/form-data" id="edit-form">
            <div class="mb-3">
                ...
                <input type="Date" name="datetime" class="form-control" id="datetime" value="<%= reservation.getDatetime() %>">
            </div>
            <div class="mb-3">
                <label for="id_cars" class="form-label">ID coche</label>
                <input type="text" name="id_cars" class="form-control" id="id_cars" value="<%= reservation.getCar().getId() %>">
            </div>
            <div class="mb-3">
                <label for="id_users" class="form-label">ID usuario</label>
                <input type="text" name="id_users" class="form-control" id="id_users" value="<%= reservation.getUser().getId() %>">
            </div>
            <div class="mb-3">
                <label for="id" class="form-label">ID</label>
                <input type="text" name="id" class="form-control" id="id" value="<%= reservation.getId() %>">
            </div>
            <div class="col-12">
